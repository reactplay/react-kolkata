      ...
      try {
        ...
        if (!response.ok) {
          ...
          if (response.status === 403) {
            ...
            throw new Error("GitHub servers are experiencing issues. Please try again later.");
          } else {
            throw new Error(
        ...
        const errorMessage = err instanceof Error ? err.message : "Failed to fetch contributors";
