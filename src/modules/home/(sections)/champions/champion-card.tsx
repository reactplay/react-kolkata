...
const ChampionCard = ({ champion }: ChampionCardProps) => {
  return (
    <div className="group relative aspect-[3/4] overflow-hidden rounded-none bg-slate-800 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/10">
      <ArchitecturalCorner />
        ...
        <div className="flex items-center gap-3">
          {champion.socials.github && (
            <Link
              ...
              className="rounded-none bg-white/10 p-2 text-white backdrop-blur-md transition-colors hover:bg-white/20"
